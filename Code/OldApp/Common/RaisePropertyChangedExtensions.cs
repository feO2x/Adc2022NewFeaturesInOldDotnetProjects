...
/// from <see cref="INotifyPropertyChanged" /> to implement <see cref="IRaisePropertyChanged" /> and
/// <see cref="BaseNotifyPropertyChanged" /> in your target class with no further code.
/// </summary>
public static class RaisePropertyChangedExtensions
{
    ...
    public static void Set<T>(this IRaisePropertyChanged target,
                              out T field,
                              T value,
    ...
    /// <exception cref="ArgumentNullException">Thrown when <paramref name="target" /> is null.</exception>
    public static bool SetIfDifferent<T>(this IRaisePropertyChanged target,
                                         ref T field,
                                         T value,
                                         [CallerMemberName] string memberName = null)
    {
